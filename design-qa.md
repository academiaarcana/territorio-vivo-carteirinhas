...
- `npm run check --offline`: aprovado integralmente em 27/08/2026 após a tentativa de prévia.
...
- Migration de papéis clínicos: aplicada no Supabase como `20260827001020 — add_clinical_professional_roles`.
- Migration territorial: aplicada como `20260827180933 — add_microareas_and_population_counts`; RLS, grants e Advisors verificados sem cadastrar totais populacionais fictícios.
