...
export function renderDashboard({ state }) {
  ...
  const content = `
    ...
    <section class="dashboard-grid">
      ...
      ${prescriptions ? '<article class="panel"><h3>Prescrições e receitas</h3><p>Monte orientações visuais temporárias com texto, via e horário, sem salvar dados clínicos no Território Vivo.</p><button class="link-button" data-go="/app/prescricoes">Abrir apoio à prescrição</button></article>' : ''}
