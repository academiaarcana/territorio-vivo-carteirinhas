...
export const visualSupportCatalog = [
  ...
  { id: 'pregnant', label: 'Pré-natal / gestante', category: 'publico', keywords: ['pre-natal', 'prenatal', 'gestante', 'gestantes', 'gravida', 'gravidas', 'puerpera', 'puerperas'] },
  ...
  { id: 'group', label: 'Grupo / reunião', category: 'acao', keywords: ['grupo', 'equipe', 'reuniao', 'roda de conversa', 'palestra', 'encontro'] },
  ...
  { id: 'elderly', label: 'Pessoa idosa', category: 'publico', keywords: ['idoso', 'idosa', 'idosos', 'idosas', 'terceira idade'] },
  { id: 'family', label: 'Família', category: 'publico', keywords: ['familia', 'familias', 'responsavel familiar'] },
