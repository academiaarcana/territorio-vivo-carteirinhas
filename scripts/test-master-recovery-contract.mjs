...
for (const sql of [prepareSql, alignSql]) {
...
console.log('Contrato da recuperação Master OK: promoção única, confirmada, serializada, sem API e sem escopo territorial.');
