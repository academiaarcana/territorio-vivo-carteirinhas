-- Repara o drift causado pela reaplicação operacional das migrations 002-005
-- depois da sequência 001-035. Não altera dados nem migrations históricas.

-- A migration 002 antiga removeu a exigência de acesso ativo para gestores.
...
-- A migration 005 antiga substituiu a proteção Gestor x Master.
...
-- A migration 003 antiga substituiu o cadastro territorial completo.
...
-- Políticas permissivas são combinadas por OR. Remove as versões antigas
-- para deixar somente profiles_select_by_scope e profiles_update_by_scope.
