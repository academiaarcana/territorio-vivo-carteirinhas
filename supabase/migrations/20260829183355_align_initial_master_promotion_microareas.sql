-- Alinha a recuperação da conta Master com a estrutura territorial normalizada.
-- A promoção continua exigindo exatamente uma conta confirmada e nenhuma Master anterior,
-- mas agora limpa explicitamente também o identificador da microárea.
...
comment on function private.promote_initial_master() is
  'Operação controlada de recuperação: promove exatamente uma conta confirmada para Master e remove todo vínculo territorial, inclusive microarea_id, quando ainda não existe Master.';
